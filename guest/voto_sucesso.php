...
?>
    ...
    <head>
        <meta charset="UTF-8">
        <title>Voto registado</title>
        <link rel="stylesheet" href="../css/estilo.css">
    </head>
    <body>
    <h1>✅ Voto registado com sucesso!</h1>
    <p>Obrigado por participar na votação.</p>

    <!--<p><a href="listar_votacoes.php">← Voltar às Votações</a></p>-->
    <center>
        <a class="link-azul" href="./listar_votacoes.php">
